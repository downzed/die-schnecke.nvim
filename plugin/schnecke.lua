...
local subcommands = {
  serve = {
    impl = core.serve,
    -- impl = function() print("TODO: serve") end, -- TODO: impl = core.serve,
  ...
  chat = {
    impl = function() print("TODO: chat") end -- TODO: impl = core.chat,
  },
  chat_with_code = {
...
local function main_cmd(opts)
  ...
  if not subcommand then
    vim.notify("die-schnecke: Unknown command: " .. subcommand_key, vim.log.levels.ERROR)
    return
  end
